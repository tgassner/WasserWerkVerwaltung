...
namespace WasserWerkVerwaltung.GUI {
    public partial class DruckenControl : UserControl {
        ...
        private void buttonJahresrechnungsdatumUebersicht_Click(object sender, EventArgs e) {
            if (checkedListBoxKunden.CheckedItems.Count <= 0) {
                MessageBox.Show("Keine Kunden markiert!");
                return;
            }
            ...
            this.wwvBLComp.PrintJahresrechnungsdatumUebersicht(selectedKundenList, (PreisData)listBoxJahre.SelectedItem);
        }

        private void buttonHalbjahresrechnungsdatumUebersicht_Click(object sender, EventArgs e) {
            if (checkedListBoxKunden.CheckedItems.Count <= 0) {
                MessageBox.Show("Keine Kunden markiert!");
                return;
            }
            ...
            this.wwvBLComp.PrintHalbjahresrechnungsdatumUebersicht(selectedKundenList, (PreisData)listBoxJahre.SelectedItem);
        }
        ...
        private void buttonStammdatenDrucken_Click(object sender, EventArgs e) {
            if (checkedListBoxKunden.CheckedItems.Count <= 0) {
                MessageBox.Show("Keine Kunden markiert!");
                return;
            }
